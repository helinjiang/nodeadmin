...
export default class extends Base {
    ...
    /**
     * 获得数据库表 think_produceitem 中所有的用户信息
     * 
     * @return {object} JSON 格式数据
     */
    async getdataAction() {
        // 查询数据库，获取所有的用户信息
        let data = await this.model('produceitem').order({
            id: "DESC",
        }).select();
    ...
    /**
     * 从数据库表 think_produceitem 中删除一条记录
     *
     * @return {object} JSON 格式数据
     */
    async deleteAction() {
